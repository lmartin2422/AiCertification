...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    """
    probability = 1.0  # Start with 1 since we are multiplying probabilities
    ...
    for person, info in people.items():
        ...
        # Calculate the probability of the person's trait
        has_trait = person in have_trait
        trait_prob = PROBS["trait"][num_genes][has_trait]

        # Multiply gene probability and trait probability
